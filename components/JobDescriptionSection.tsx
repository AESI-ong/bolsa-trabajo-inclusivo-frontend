...
const JobDescriptionSection = ({ job }: Props) => {
  return (
    <section className="pt-2 md:pt-12">
      <div className="flex items-start justify-between flex-col md:flex-row gap-16">
        ...
        {/* Columna derecha */}
        <aside className="w-full max-w-auto md:max-w-80 bg-[#2c6db6] bg-opacity-40 px-6 pb-6 rounded-xl shadow-md text-gray-800">
